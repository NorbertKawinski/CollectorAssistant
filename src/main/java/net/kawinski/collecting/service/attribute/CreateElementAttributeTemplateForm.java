...
public class CreateElementAttributeTemplateForm extends CreateAttributeTemplateForm {
    public CreateElementAttributeTemplateForm(@NotNull final Category category,
        ...
        super(category, AttributeTarget.Element, name, attributeType, displayOrder, searchable);
    }
}
