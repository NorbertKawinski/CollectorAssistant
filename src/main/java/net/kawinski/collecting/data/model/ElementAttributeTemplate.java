...
@Entity(name = "ElementAttributeTemplate")
...
public class ElementAttributeTemplate extends BaseAttributeTemplate {

    private static final long serialVersionUID = 1L;

    @Default
    public ElementAttributeTemplate(final Category category, @NotNull @Size(min = 1, max = 32) final String name, final AttributeType type,
